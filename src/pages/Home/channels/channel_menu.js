    ...
    return (
        <div className="channel-menu center-column-container" ref={menu} style={{ top: y + 20, left: x, transform: "translateX(-95%)" }}>
            <button className="channel-menu-btn spaced-container" onClick={() => { setCard("channel_settings"); close() }}>
                Channel Settings
                <svg width="16" height="16" fill="var(--FONT_COLOR)" viewBox="0 0 16 16">
            ...
            <button className="channel-menu-btn spaced-container" onClick={() => { setCard("channel_members"); close() }}>
                Channel Members
                <svg width="16" height="16" fill="var(--FONT_COLOR)" viewBox="0 0 16 16">
            ...
            <button className="channel-menu-btn spaced-container" onClick={() => { setCard("channel_invite"); close() }}>
                Invite People
                <svg width="16" height="16" fill="var(--FONT_COLOR)" viewBox="0 0 16 16">
