                ...
                <>
                    <div className="spaced-container">
                        <div className="avatar-wrapper center-container" onClick={() => file_input.current.click()}>
                            <img className="settings-avatar skeleton" ref={channel_icon} src={channel.direct ? `/api/images/${channel.icon}.webp` : `/api/images/channels/${channel.icon}.webp`} onError={(e) => { if (e.target.src !== "/api/images/channels/generic.webp") e.target.src = "/api/images/channels/generic.webp" }} onLoad={(e) => e.target.classList.remove("skeleton")} />
