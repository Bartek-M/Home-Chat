    ...
    return (
        <div className="login-page center-container">
            <div className="settings-edit-card column-container">
                ...
                {verified === false && <div className="justified-wrapper">Couldn't recover your email - ticket might be invalid or expired. Remember, that you can also login with your username and change your email manually.</div>}
                {verified && <div className="justified-wrapper">Updated your email back to '{verified}'.</div>}
